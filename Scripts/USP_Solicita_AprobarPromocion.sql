...
-- Description	: Envía correo electrónico solicitando aprobación de Promociones y Descuentos
--				  que aún estan en espera (JOB)
-- ==========================================================================================
...
BEGIN
	...
	--//=========================================\\--
	-- Declaramos Cursor para buscar todas las promociones en espera de aprobación
	...
	BEGIN
		...
		BEGIN
			...
			-- Asunto del Correo
			Set @asunto = '[Promociones Bata] Recordatorio - Solicitud de Aprobación - ' + @desc_promo;
			-- Cuerpo del Correo
			...
			Set @cuerpo +=	        '</tr>';
			Set @cuerpo +=	        '<tr>';
			Set @cuerpo +=	            '<td colspan="6">El sistema de solicitudes de ofertas y promociones le recuerda que tiene pendiente la siguiente solicitud, que requiere su aprobación:</td>';
			Set @cuerpo +=	        '</tr>';
			Set @cuerpo +=	        '<tr>';
			...
			Set @cuerpo +=	        '</tr>';
			Set @cuerpo +=	        '<tr>';
			Set @cuerpo +=	            '<td colspan="6" style="font-size:12px;color:#2B5290">(Para ver el detalle completo de la solicitud <a href="' + @url_datos_adic + @url_complementa + '">haga clic aquí.</a>)</td>';
			Set @cuerpo +=	        '</tr>';
